...
for activation in activations:
    # Même seed pour chaque modèle : sans ça, un écart de résultat pourrait venir du hasard
    # de l'initialisation des poids plutôt que de l'activation elle-même
    ...
    # Première epoch où val_loss passe sous 0.1 : mesure la vitesse de convergence ("N/A" si jamais atteint)
    val_losses = history.history['val_loss']
    convergence_epoch = next((i + 1 for i, v in enumerate(val_losses) if v < 0.1), "N/A")
