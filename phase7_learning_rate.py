...
for lr, label in zip(learning_rates, lr_labels):
    # Même seed pour chaque modèle : l'écart de résultat doit venir du learning rate, pas du hasard de l'initialisation
    ...
    # Seul le learning rate de l'optimiseur change d'un modèle à l'autre
